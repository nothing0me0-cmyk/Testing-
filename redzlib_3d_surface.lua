...
-- ================================ --
--   SURFACE GUI CONVERSION LOGIC   --
-- ================================ --
local ScreenFind = CoreGui:FindFirstChild("redz Library V5")
if ScreenFind then
	if ScreenFind:IsA("SurfaceGui") and ScreenFind.Adornee then
		ScreenFind.Adornee:Destroy()
	end
	ScreenFind:Destroy()
end

local uiPart = Create("Part", workspace.CurrentCamera, {
	Name = "RedzLibPart",
	Anchored = true,
	CanCollide = false,
	Transparency = 1,
	Size = Vector3.new(4 * (ViewportSize.X / ViewportSize.Y), 4, 0.1) 
})

RunService.RenderStepped:Connect(function()
	local cam = workspace.CurrentCamera
	if cam then
		uiPart.CFrame = cam.CFrame * CFrame.new(0, 0, -5)
	end
end)

local ScreenGui = Create("SurfaceGui", CoreGui, {
